<template>
    <header>
        <nav class = "container">
            ...
            <img v-on:click="opemMenu" alt="Abrir menu" id = "menu-button" src = "https://raw.githubusercontent.com/william-costa/wdev-mock-site-resources/master/assets/images/menu.svg">
